...
import { extractTextFromFile, isSupportedFile } from "./modules/file";
import {
  createOrder,
  listOrders,
  advanceOrderStatus,
...
export default function App() {
  ...
  function handleSelectedFile(file, fromDrop = false) {
    if (!file) {
      setActiveFile(null);
        ...
        <main className="container py-3 py-md-4">
          <section className={`page-section ${activeSection === "home" ? "is-active" : ""}`} data-section="home">
            <section id="homeIntro" className={`hero ${hasStartedAnalysisFlow ? "hidden" : ""}`}>
              ...
              <div className="how-grid row g-3">
                <article className="how-item col-md-4">
                  <h3>1. Upload Report</h3>
                  <p>Add PDF, DOCX, or TXT lab reports safely.</p>
                </article>
                <article className="how-item col-md-4">
                  <h3>2. Analyze Values</h3>
                  <p>Ranges are compared and summarized in plain language.</p>
                </article>
                <article className="how-item col-md-4">
                  <h3>3. Follow Guidance</h3>
